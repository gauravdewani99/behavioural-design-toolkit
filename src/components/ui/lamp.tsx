    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-28 w-64 -translate-y-[4rem] rounded-full bg-cyan-400 blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
        ...
        <div className="absolute inset-auto z-40 h-36 w-full -translate-y-[8rem] bg-slate-950"></div>
      </div>
