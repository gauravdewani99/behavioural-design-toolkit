...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex items-center justify-center overflow-hidden bg-slate-950 w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute inset-auto z-50 h-16 w-[16rem] -translate-y-1/2 rounded-full bg-cyan-500 opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "4rem" }}
          ...
          className="absolute inset-auto z-30 h-16 w-40 -translate-y-[3rem] rounded-full bg-cyan-400 blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: "6rem" }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-[16rem] -translate-y-[4rem] bg-cyan-400 "
        ></motion.div>
