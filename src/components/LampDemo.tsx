...
export function LampDemo() {
  ...
  return (
    <div className="h-[70vh] flex items-center justify-center">
      <LampContainer tubeLightControls={tubeLightControls} className="h-full max-h-[65vh]">
        <motion.h1
          ...
          className="mt-4 bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-3xl font-medium tracking-tight text-transparent md:text-5xl"
        >
