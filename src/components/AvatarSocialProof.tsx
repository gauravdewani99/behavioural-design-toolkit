...
export function AvatarSocialProof() {
  return (
    <div className="flex items-center rounded-full border border-border bg-background p-2 shadow shadow-black/5 w-fit mx-auto">
      <div className="flex -space-x-2">
        <img
          className="rounded-full ring-1 ring-background w-8 h-8"
