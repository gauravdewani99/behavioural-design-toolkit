  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container py-6">
        <a href="/" className="flex items-center text-primary hover:text-primary/80 mb-4 group">
          <ArrowLeft className="mr-2 h-4 w-4 transition-transform group-hover:-translate-x-1" />
          Back to Portfolio
        </a>
        
        <h1 className="text-2xl md:text-3xl font-bold text-gradient mb-4">Visual Salience</h1>
